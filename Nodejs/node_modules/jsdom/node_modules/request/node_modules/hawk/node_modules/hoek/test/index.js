...
describe('Hoek', function () {
    ...
    describe('#loadDirModules', function () {
        ...
        it('should load models from directory', function (done) {

            var target = {};
            Hoek.loadDirModules(__dirname + '/models', ['test2'], target);
        ...
        it('should list models from directory into function', function (done) {

            var target = {};
            Hoek.loadDirModules(__dirname + '/models', ['test2'], function (path, name, capName) {
